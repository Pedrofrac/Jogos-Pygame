...
def menu_principal():
    ...
    ativo_input = False
    rect_check = pygame.Rect(x_centro, 650, 30, 30)
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.KEYDOWN:
                if ativo_input:
                    ...
                    elif len(seed_texto) < 10 and evento.unicode.isalnum(): 
                        seed_texto += evento.unicode.upper()
